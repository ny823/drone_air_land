...
#include "ros/ros.h"
#include "../include/state_machine_position_vel.hpp"
...
int main(int argc, char **argv)
{
    ...
    YAML::Node message = YAML::LoadFile("/home/drone/acfly_ws/src/linetracing/config/position.yaml");
    tf::Vector3 po1;
    tf::Vector3 po2;
    tf::Vector3 po3;
    tf::Vector3 po4;
    ...
    // }
    // //??????,????????
    // sm.process_event(drone::line_tracing{});
    // // while (sm.is("line_tracing"_s))
    // // {
    // //     sm.process_event(drone::tickOnce{});
    ...
    // }
    // target.SetTarget(0, 0, 0, 1, 1, -1, -0.1);
    // //target.SetPosition_yaml(po4);
    // sm.process_event(drone::moveTo{target});
    // while (sm.is("moving"_s))
    // {
    //     sm.process_event(drone::tickOnce{});
    //     ROS_INFO("44444444444444444444444444444444444444444");
    // }
