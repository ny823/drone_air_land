...
namespace color
{
    ...
    void color_Range(cv::InputArray img, cv::OutputArray imgThresholded, const color_kind &ctrl)
    {
        ...
        case red:
        {
            ...
            cv::inRange(imghsv, cv::Scalar(156, 43, 46), cv::Scalar(180, 255, 255), imgThresholded1); //红色
            cv::inRange(imghsv, cv::Scalar(0, 43, 46), cv::Scalar(10, 255, 255), imgThresholded2);
